...
source_yaml: "aid: bloomberg-media-platforms:bloomberg-media-api\nname: Bloomberg Media API\ndescription: Content distribution API for Bloomberg's editorial content including articles, video clips,\n  and multimedia from Bloomberg.com, Bloomberg Businessweek, and other Bloomberg media properties.\nhumanURL: https://www.bloomberg.com/professional/\nbaseURL: https://api.bloomberg.com/media\ntags:\n- Media Content\n- Articles\n- Video\n- Editorial\nproperties:\n- type: Documentation\n  url: https://www.bloomberg.com/professional/\n"
