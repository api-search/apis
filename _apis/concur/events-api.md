...
source_yaml: "aid: concur:events-api\nname: SAP Concur Events API\ndescription: Event subscription API enabling applications to receive real-time notifications when events\n  occur in Concur such as expense report submissions, approvals, and status changes.\nhumanURL: https://developer.concur.com/api-reference/ess/v4.event-subscription.html\nbaseURL: https://us.api.concursolutions.com/events/v4/\ntags:\n- Events\n- REST\n- Subscriptions\n- Webhooks\nproperties:\n- type: Documentation\n  url: https://developer.concur.com/api-reference/ess/v4.event-subscription.html\n"
