...
slug: job-search
source_yaml: "aid: indeed:job-search\nname: Indeed Job Search API\ndescription: Search for jobs by keyword, location, and other criteria. Returns job listings with details\n  including title, company, location, and description. This API is deprecated and not available for new\n  integrations.\nimage: https://www.indeed.com/images/indeed-logo.png\nhumanURL: https://developer.indeed.com/docs/publisher-jobs/job-search\nbaseURL: https://api.indeed.com\ntags:\n- Deprecated\n- Jobs\n- Listings\n- Search\nproperties:\n- type: Documentation\n  url: https://opensource.indeedeng.io/api-documentation/docs/job-search/\ncontact:\n- FN: Indeed API Support\n  email: opensource@indeed.com\n  url: https://opensource.indeedeng.io/\n"
