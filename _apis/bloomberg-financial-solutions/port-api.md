...
slug: port-api
source_yaml: "aid: bloomberg-financial-solutions:port-api\nname: Bloomberg PORT (Portfolio Risk and Analytics)\ndescription: Bloomberg's portfolio risk and analytics solution providing attribution, risk factor analysis,\n  stress testing, and regulatory reporting for asset managers and institutional investors.\nhumanURL: https://www.bloomberg.com/professional/solution/portfolio-risk-analytics/\nbaseURL: blpapi://localhost:8194\ntags:\n- Portfolio Analytics\n- Risk\n- Attribution\n- Regulatory\nproperties:\n- type: Documentation\n  url: https://www.bloomberg.com/professional/solution/portfolio-risk-analytics/\n"
