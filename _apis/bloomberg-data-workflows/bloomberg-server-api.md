...
source_yaml: "aid: bloomberg-data-workflows:bloomberg-server-api\nname: Bloomberg SAPI (Server API)\ndescription: Real-time and historical market data API providing access to Bloomberg's comprehensive financial\n  data through a server-based connection.\nhumanURL: https://www.bloomberg.com/professional/products/data/data-connectivity/server-api/\ntags:\n- Historical Data\n- Market Data\n- Real-Time Data\n- Streaming\nproperties:\n- type: Documentation\n  url: https://www.bloomberg.com/professional/support/api-library/\n- type: SDKs\n  url: https://bloomberg.github.io/blpapi-docs/\n"
