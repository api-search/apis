...
source_yaml: "aid: bloomberg-news:market-data-api\nname: Bloomberg Market Data API\ndescription: Provides access to real-time and historical market data including stocks, bonds, commodities,\n  and currencies through the Bloomberg Terminal and enterprise data feeds.\nhumanURL: https://www.bloomberg.com/professional/support/api-library/\nbaseURL: https://api.bloomberg.com/v1\ntags:\n- Financial Data\n- Historical Data\n- Market Data\n- Real-Time\nproperties:\n- type: Documentation\n  url: https://www.bloomberg.com/professional/support/api-library/\n- type: Authentication\n  url: https://www.bloomberg.com/professional/support/api-library/#authentication\n- type: GettingStarted\n  url: https://bloomberg.github.io/blpapi-docs/\n"
