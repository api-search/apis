...
source_yaml: "aid: audatex:solera-api-gateway\nname: Solera API Gateway\ndescription: 'The Solera API Gateway provides access to Audatex and Solera claims processing services\n  including ClaimImage document return and other automotive claims data APIs for North American insurance\n  markets.\n\n  '\nhumanURL: https://na.api.solera.com/\nbaseURL: https://na.api.solera.com\ntags:\n- Claims\n- Documents\n- Insurance\n- Solera\nproperties:\n- type: Documentation\n  url: https://na.api.solera.com/\n- type: Authentication\n  url: https://na.api.solera.com/\n"
