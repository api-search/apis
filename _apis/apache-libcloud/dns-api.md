...
source_yaml: "aid: apache-libcloud:dns-api\nname: Apache Libcloud DNS API\ndescription: The Libcloud DNS API provides a unified Python interface for managing DNS zones and records\n  across Route53, Azure DNS, Google Cloud DNS, and other providers.\nhumanURL: https://libcloud.readthedocs.io/en/stable/dns/\ntags:\n- Cloud\n- DNS\n- Python\nproperties:\n- type: Documentation\n  url: https://libcloud.readthedocs.io/en/stable/dns/\n"
