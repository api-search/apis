...
slug: cli
source_yaml: "aid: apache-jmeter:cli\nname: Apache JMeter CLI\ndescription: JMeter command-line interface for running load tests in non-GUI mode for CI/CD integration,\n  including options for test plan execution, result reporting, and distributed testing.\nhumanURL: https://jmeter.apache.org/usermanual/get-started.html#non_gui\ntags:\n- CLI\n- Performance Testing\nproperties:\n- type: Documentation\n  url: https://jmeter.apache.org/usermanual/get-started.html#non_gui\n"
