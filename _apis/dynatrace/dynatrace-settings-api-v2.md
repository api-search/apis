...
source_yaml: "aid: dynatrace:dynatrace-settings-api-v2\nname: Dynatrace Settings API 2.0\ntags:\n- Configuration\n- Management\n- Observability\n- Settings\nhumanURL: https://docs.dynatrace.com/docs/discover-dynatrace/references/dynatrace-api/environment-api/settings-v2\nbaseURL: https://mySampleEnv.live.dynatrace.com/api/v2\nimage: https://www.dynatrace.com/logo.png\nproperties:\n- url: https://docs.dynatrace.com/docs/discover-dynatrace/references/dynatrace-api/environment-api/settings-v2\n  type: Documentation\ndescription: The Dynatrace Settings API 2.0 is the modern, schema-driven configuration API for managing\n  Dynatrace environment settings objects. It replaces portions of the Configuration API v1 and provides\n  a unified approach to reading and writing anomaly detection, alerting, and platform settings through\n  versioned schema definitions.\n"
