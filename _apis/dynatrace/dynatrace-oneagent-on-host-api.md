...
source_yaml: "aid: dynatrace:dynatrace-oneagent-on-host-api\nname: Dynatrace OneAgent on a Host API\ntags:\n- Deployment\n- Host Monitoring\n- Infrastructure\n- OneAgent\nhumanURL: https://docs.dynatrace.com/docs/discover-dynatrace/references/dynatrace-api/environment-api/oneagent-on-host\nbaseURL: https://mySampleEnv.live.dynatrace.com/api/v2\nimage: https://www.dynatrace.com/logo.png\nproperties:\n- url: https://docs.dynatrace.com/docs/discover-dynatrace/references/dynatrace-api/environment-api/oneagent-on-host\n  type: Documentation\ndescription: The Dynatrace OneAgent on a Host API enables you to check the configuration and status of\n  OneAgent instances deployed on your hosts. It provides endpoints for listing hosts with OneAgent details,\n  retrieving agent version information, and monitoring agent health and connectivity within a Dynatrace\n  environment.\n"
