...
source_yaml: "aid: microsoft-azure:azure-monitor-metric-batch\nname: Microsoft Azure Monitor Metric Batch\ntags: []\nimage: https://kinlane-productions2.s3.amazonaws.com/apis-json/apis-json-logo.jpg\nhumanURL: https://learn.microsoft.com/en-us/azure/batch/monitor-batch\nproperties:\n- url: openapi/azure-monitor-metric-batch-openapi-original.yml\n  type: OpenAPI\n- url: https://learn.microsoft.com/en-us/azure/batch/monitor-batch\n  type: Documentation\ndescription: Microsoft Azure Monitor Metric Batch is a service that allows users to collect, correlate,\n  and analyze metrics from various sources within their Azure environment. This tool enables users to\n  easily track and monitor performance metrics, identify potential issues, and make informed decisions\n  based on real-time data. With Azure Monitor Metric Batch, users can aggregate and batch metric data,\n  set up custom alerts and notifications, and gain insights into their overall system performance.\n"
