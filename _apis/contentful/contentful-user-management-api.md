...
source_yaml: "aid: contentful:contentful-user-management-api\nname: Contentful User Management API\ntags:\n- CMS\n- Content\n- Users\nimage: https://kinlane-productions2.s3.amazonaws.com/apis-json/apis-json-logo.jpg\nbaseURL: https://api.example.com\nhumanURL: https://www.contentful.com/developers/docs/references/user-management-api/\nproperties:\n- url: https://www.contentful.com/developers/docs/references/user-management-api/\n  type: Documentation\ndescription: Contentful's User Management API helps organizations programmatically manage their organizations,\n  organization memberships, teams, space memberships and more.\n"
