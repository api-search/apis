...
source_yaml: "aid: bureau-of-economic-analysis:bea-gdp-data\nname: BEA GDP Data\ntags:\n- Economics\n- GDP\n- Federal Government\n- National Accounts\nhumanURL: https://www.bea.gov/data/gdp/gross-domestic-product\nbaseURL: https://apps.bea.gov/api/data\nproperties:\n- url: https://www.bea.gov/data/gdp/gross-domestic-product\n  type: Documentation\n- url: https://apps.bea.gov/api/data?UserID=YOUR_KEY&method=GetData&DataSetName=NIPA&TableName=T10101&Frequency=Q&Year=X&ResultFormat=JSON\n  type: DataAPI\ndescription: Gross Domestic Product (GDP) data from the BEA, available quarterly and annually. Includes\n  GDP growth rates, GDP by expenditure components, and real vs. nominal GDP measures.\n"
