...
source_yaml: "aid: datadog:datadog-apm-retention-filters-api\nname: Datadog APM Retention Filters API\ntags:\n- APM\n- Retention\n- Tracing\nhumanURL: https://docs.datadoghq.com/api/latest/apm-retention-filters/\nbaseURL: https://api.datadoghq.com\nimage: https://imgix.datadoghq.com/img/dd_logo_n_70x75.png\nproperties:\n- url: https://docs.datadoghq.com/api/latest/apm-retention-filters/\n  type: Documentation\n- url: https://docs.datadoghq.com/tracing/trace_pipeline/trace_retention/\n  type: Reference\ndescription: The APM Retention Filters API allows you to manage configuration of APM retention filters\n  for your organization. Retention filters control which traces are indexed and retained for analysis\n  and require Admin rights to interact with.\n"
