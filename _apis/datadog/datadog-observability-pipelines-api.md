...
source_yaml: "aid: datadog:datadog-observability-pipelines-api\nname: Datadog Observability Pipelines API\ntags:\n- Logs\n- Observability Pipelines\nhumanURL: https://docs.datadoghq.com/api/latest/observability-pipelines/\nbaseURL: https://api.datadoghq.com\nimage: https://imgix.datadoghq.com/img/dd_logo_n_70x75.png\nproperties:\n- url: https://docs.datadoghq.com/api/latest/observability-pipelines/\n  type: Documentation\n- url: https://docs.datadoghq.com/observability_pipelines/\n  type: Reference\ndescription: The Observability Pipelines API allows you to collect and process logs within your own infrastructure\n  and route them to downstream integrations. It provides programmatic management of pipeline configurations.\n"
