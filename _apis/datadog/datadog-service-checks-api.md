...
source_yaml: "aid: datadog:datadog-service-checks-api\nname: Datadog Service Checks API\ntags:\n- Monitoring\n- Service Checks\nhumanURL: https://docs.datadoghq.com/api/latest/service-checks/\nbaseURL: https://api.datadoghq.com\nimage: https://imgix.datadoghq.com/img/dd_logo_n_70x75.png\nproperties:\n- url: https://docs.datadoghq.com/api/latest/service-checks/\n  type: Documentation\ndescription: The Service Checks API allows you to submit a list of service checks to Datadog. Service\n  checks can be submitted up to 10 minutes in the past and are used to monitor the status of services.\n"
