...
source_yaml: "aid: datadog:datadog-roles-api\nname: Datadog Roles API\ntags:\n- Access Control\n- RBAC\n- Roles\nhumanURL: https://docs.datadoghq.com/api/latest/roles/\nbaseURL: https://api.datadoghq.com\nimage: https://imgix.datadoghq.com/img/dd_logo_n_70x75.png\nproperties:\n- url: https://docs.datadoghq.com/api/latest/roles/\n  type: Documentation\n- url: https://docs.datadoghq.com/account_management/rbac/\n  type: Reference\ndescription: The Roles API is used to create and manage Datadog roles, the global permissions they grant,\n  and which users belong to them. Roles provide role-based access control for Datadog resources and features.\n"
