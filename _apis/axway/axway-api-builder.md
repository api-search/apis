...
source_yaml: "aid: axway:axway-api-builder\nname: Axway API Builder\ndescription: Axway API Builder is a low-code tool for building and deploying microservices and APIs from\n  data sources and business logic. It provides a visual flow editor to compose API endpoints, connect\n  to databases, and integrate with third-party services as containerized Node.js microservices.\nhumanURL: https://docs.axway.com/bundle/api-builder/\nbaseURL: https://docs.axway.com\ntags:\n- API Builder\n- Low-Code\n- Microservices\n- Node.js\nproperties:\n- type: Documentation\n  url: https://docs.axway.com/bundle/api-builder/\n- type: GettingStarted\n  url: https://docs.axway.com/bundle/api-builder/page/docs/getting_started/index.html\n- type: ChangeLog\n  url: https://docs.axway.com/bundle/api-builder/page/docs/release_notes/index.html\n- type: GitHubRepository\n  url: https://github.com/Axway/api-builder-standalone-tech-enablement\n"
