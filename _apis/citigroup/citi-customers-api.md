...
source_yaml: "aid: citigroup:citi-customers-api\nname: Citi Customers API\ntags:\n- Customers\n- Identity\n- KYC\n- Profiles\nimage: https://kinlane-productions2.s3.amazonaws.com/apis-json/apis-json-logo.jpg\nhumanURL: https://developer.citi.com/\nproperties:\n- url: https://developer.citi.com/\n  type: Documentation\ndescription: The Citi Customers API provides authorized access to customer profile information including\n  contact details and demographic data for use in onboarding and KYC workflows.\n"
