...
source_yaml: "aid: bloomberg-tradebook:emsx-tradebook-integration\nname: Bloomberg EMSX-Tradebook Integration\ndescription: Integration between Bloomberg's Electronic Order Management System (EMSX) and Tradebook for\n  seamless order routing from the Bloomberg Terminal to Tradebook execution desks and algorithms.\nhumanURL: https://www.bloomberg.com/professional/solution/emsx/\nbaseURL: blpapi://localhost:8194\ntags:\n- EMSX\n- Terminal Integration\n- Order Management\nproperties:\n- type: Documentation\n  url: https://www.bloomberg.com/professional/solution/emsx/\n"
