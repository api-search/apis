...
source_yaml: "aid: bloomberg-indices:galaxy-crypto-index\nname: Bloomberg Galaxy Crypto Index\ndescription: Access cryptocurrency index data from the Bloomberg Galaxy Crypto Index family, tracking\n  the performance of the largest and most liquid cryptocurrencies.\nhumanURL: https://www.bloomberg.com/professional/solution/indices/\nbaseURL: blpapi://localhost:8194\ntags:\n- Crypto Index\n- Cryptocurrency\n- Digital Assets\nproperties:\n- type: Documentation\n  url: https://www.bloomberg.com/professional/solution/indices/\n"
