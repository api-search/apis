...
slug: ci-api
source_yaml: "aid: harness:ci-api\nname: Harness Continuous Integration API\ndescription: The Harness CI module helps build faster with features including code building, testing,\n  dependency management, artifact uploads, and build monitoring with AI-powered Test Intelligence.\nhumanURL: https://developer.harness.io/docs/continuous-integration\ntags:\n- Builds\n- CI\n- Continuous Integration\n- Pipelines\nproperties:\n- type: Documentation\n  url: https://developer.harness.io/docs/continuous-integration\n- type: APIReference\n  url: https://apidocs.harness.io/pipeline\n"
