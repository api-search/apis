...
source_yaml: "aid: harness:iacm-api\nname: Harness Infrastructure as Code Management API\ndescription: APIs for defining, deploying, and managing infrastructure across environments with Terraform\n  and IaC tool integration.\nhumanURL: https://developer.harness.io/docs/infrastructure-as-code-management\ntags:\n- IaCM\n- Infrastructure as Code\n- Provisioning\n- Terraform\nproperties:\n- type: Documentation\n  url: https://developer.harness.io/docs/infrastructure-as-code-management\n"
