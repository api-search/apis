...
source_yaml: "aid: apimatic:apimatic-api-transformer-api\nname: APIMatic API Transformer API\ndescription: APIMatic API Transformer converts API definition files between more than 15 supported API\n  specification formats including OpenAPI, RAML, API Blueprint, WSDL, WADL, and Postman Collections.\nhumanURL: https://www.apimatic.io/solution/transformer\nbaseURL: https://api.apimatic.io\ntags:\n- API Conversion\n- Format Transformation\n- OpenAPI\n- Postman\n- RAML\nproperties:\n- type: Documentation\n  url: https://docs.apimatic.io/api-transformer/overview-transformer/\n"
