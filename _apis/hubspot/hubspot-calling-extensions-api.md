...
source_yaml: "aid: hubspot:hubspot-calling-extensions-api\nname: HubSpot Calling Extensions API\ntags:\n- Calling\n- CRM\n- Extensions\n- SDK\nimage: https://kinlane-productions2.s3.amazonaws.com/apis-json/apis-json-logo.jpg\nbaseURL: https://api.hubapi.com\nhumanURL: https://developers.hubspot.com/docs/guides/api/crm/extensions/calling-sdk\nproperties:\n- url: https://developers.hubspot.com/docs/guides/api/crm/extensions/calling-sdk\n  type: Documentation\ndescription: The calling extensions SDK enables apps to provide a custom calling option to HubSpot users\n  directly from CRM records. The SDK facilitates bidirectional communication between calling applications\n  and HubSpot, including call event messaging and automatic engagement record creation.\n"
