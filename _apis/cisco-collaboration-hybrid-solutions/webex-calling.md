...
slug: webex-calling
source_yaml: "aid: cisco-collaboration-hybrid-solutions:webex-calling\nname: Webex Calling API\ntags:\n- Call Control\n- Calling\n- Telephony\n- Voicemail\nhumanURL: https://developer.webex.com/docs/api/v1/webex-calling\nbaseURL: https://webexapis.com/v1\nproperties:\n- url: https://developer.webex.com/docs/api/v1/webex-calling\n  type: Documentation\n- url: https://developer.webex.com/docs/api/v1/call-controls\n  type: Reference\ndescription: Cloud calling capabilities including call control, dial plans, voicemail, voice portals,\n  queues, hunt groups, and number provisioning.\n"
