...
source_yaml: "aid: apache-james:jmap-api\nname: Apache James JMAP API\ndescription: The JMAP (JSON Meta Application Protocol) implementation in James provides a modern, efficient\n  email protocol for synchronizing messages, mailboxes, contacts, and calendars for email clients.\nhumanURL: https://james.apache.org/server/rfcs-compliance.html\ntags:\n- Email\n- JMAP\n- JSON\nproperties:\n- type: Documentation\n  url: https://james.apache.org/server/rfcs-compliance.html\n"
