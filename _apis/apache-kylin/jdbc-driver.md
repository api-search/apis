...
source_yaml: "aid: apache-kylin:jdbc-driver\nname: Apache Kylin JDBC Driver\ndescription: The Kylin JDBC driver provides SQL-over-Kylin access for BI tools and SQL clients, enabling\n  standard JDBC connectivity to Kylin OLAP cubes.\nhumanURL: https://kylin.apache.org/docs/tutorial/jdbc.html\ntags:\n- JDBC\n- SQL\nproperties:\n- type: Documentation\n  url: https://kylin.apache.org/docs/tutorial/jdbc.html\n"
