...
baseURL: ''
description: Apache Cordova provides a JavaScript plugin API for accessing native device capabilities (camera, GPS, file system, contacts, etc.), a CLI for project management and multi-platform builds, a plugin development API for creating native bridges, and platform-specific runtimes for iOS, Android, and Electron.
