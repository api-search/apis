...
source_yaml: "aid: qlik:web-integrations\nname: Qlik Web Integrations API\ndescription: Manages web integration configurations that allow external websites to embed and interact\n  with Qlik Cloud content.\nhumanURL: https://qlik.dev/apis/rest/web-integrations/\ntags:\n- Embedding\n- Web Integrations\nproperties:\n- type: Documentation\n  url: https://qlik.dev/apis/rest/web-integrations/\n- type: OpenAPI\n  url: https://qlik.dev/specs/rest/web-integrations.json\n"
