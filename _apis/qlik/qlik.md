...
source_yaml: "aid: qlik:qlik\nname: Qlik\ndescription: Qlik provides APIs to support automation, configuration, observability, and integration with\n  third-party applications to incorporate Qlik Cloud capabilities directly into those applications.\nhumanURL: https://qlik.dev/apis/\nbaseURL: https://{tenant}.{region}.qlikcloud.com/api/v1\ntags: []\nproperties:\n- type: Documentation\n  url: https://qlik.dev/apis/\n- type: GettingStarted\n  url: https://qlik.dev/get-started\n"
