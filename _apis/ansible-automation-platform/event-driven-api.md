...
source_yaml: "aid: ansible-automation-platform:event-driven-api\nname: Ansible Event-Driven Automation API\ndescription: API for Event-Driven Ansible (EDA) Controller enabling management of rulebooks, activations,\n  and event sources for automated response to infrastructure and application events.\nhumanURL: https://docs.ansible.com/automation-controller/latest/html/userguide/eda.html\nbaseURL: https://eda-host/api/eda/v1/\ntags:\n- EDA\n- Event-Driven\n- REST\n- Rulebooks\nproperties:\n- type: Documentation\n  url: https://docs.ansible.com/automation-controller/latest/html/userguide/eda.html\n"
