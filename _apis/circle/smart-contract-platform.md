...
source_yaml: "aid: circle:smart-contract-platform\nname: Smart Contract Platform\ntags:\n- Contracts\n- EVM\n- Web3\nhumanURL: https://developers.circle.com/w3s/smart-contract-platform\nbaseURL: https://api.circle.com/v1/w3s\nproperties:\n- url: https://developers.circle.com/w3s/smart-contract-platform\n  type: Documentation\n- url: https://developers.circle.com/openapi/smart-contract-platform.yaml\n  type: OpenAPI\ndescription: Deploy, query, and interact with smart contracts across supported blockchains, including\n  ERC-20 and ERC-721 templates and arbitrary contract calls.\n"
