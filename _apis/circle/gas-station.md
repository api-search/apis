...
slug: gas-station
source_yaml: "aid: circle:gas-station\nname: Gas Station and Paymaster\ntags:\n- Gas Sponsorship\n- Paymaster\n- USDC\nhumanURL: https://developers.circle.com/w3s/gas-station\nbaseURL: https://api.circle.com/v1/w3s\nproperties:\n- url: https://developers.circle.com/w3s/gas-station\n  type: Documentation\ndescription: Sponsor gas fees on behalf of users or let users pay gas in USDC via Circle Paymaster, removing\n  native-token friction from onboarding.\n"
