...
source_yaml: "aid: carsxe:vehicle-history-api\nname: CarsXE Vehicle History API\ndescription: Raw vehicle-history data endpoint returning title records, accident history, odometer readings,\n  service history, and salvage/lemon flags for a given VIN.\nhumanURL: https://api.carsxe.com/vehicle-history\nbaseURL: https://api.carsxe.com\ntags:\n- History\n- Title\n- Accident\nproperties:\n- type: Documentation\n  url: https://api.carsxe.com/vehicle-history\n"
