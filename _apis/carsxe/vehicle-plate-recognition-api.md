...
source_yaml: "aid: carsxe:vehicle-plate-recognition-api\nname: CarsXE Vehicle Plate Recognition API\ndescription: Image-to-text OCR for license plates. Paired with the Plate Decoder, enables full vehicle\n  lookup starting from a plate image, supporting parking, access-control, law-enforcement, and valet use\n  cases.\nhumanURL: https://api.carsxe.com/vehicle-plate-recognition\nbaseURL: https://api.carsxe.com\ntags:\n- License Plate\n- OCR\n- AI\nproperties:\n- type: Documentation\n  url: https://api.carsxe.com/vehicle-plate-recognition\n"
