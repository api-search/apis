...
slug: vin-ocr-api
source_yaml: "aid: carsxe:vin-ocr-api\nname: CarsXE VIN OCR API\ndescription: OCR endpoint that extracts a VIN string from an image of a VIN plate, windshield, or document,\n  enabling mobile-first vehicle-onboarding and inspection workflows.\nhumanURL: https://api.carsxe.com/vin-ocr\nbaseURL: https://api.carsxe.com\ntags:\n- OCR\n- VIN\n- AI\nproperties:\n- type: Documentation\n  url: https://api.carsxe.com/vin-ocr\n"
