...
source_yaml: "aid: databricks:lakeview-api\nname: Databricks Lakeview API\ntags:\n- Analytics\n- Dashboards\n- Visualization\nhumanURL: https://docs.databricks.com/api/workspace/lakeview\nproperties:\n- url: https://docs.databricks.com/api/workspace/lakeview\n  type: Documentation\ndescription: The Databricks Lakeview API allows you to create, update, get, list, and delete AI/BI dashboards.\n  Lakeview dashboards provide a modern visualization experience built on top of Databricks SQL, enabling\n  interactive data exploration and business intelligence reporting.\n"
