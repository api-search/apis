...
slug: grants-api
source_yaml: "aid: databricks:grants-api\nname: Databricks Grants API\ntags:\n- Access Control\n- Security\n- Unity Catalog\nhumanURL: https://docs.databricks.com/api/workspace/grants\nproperties:\n- url: https://docs.databricks.com/api/workspace/grants\n  type: Documentation\ndescription: The Databricks Grants API is part of Unity Catalog and allows you to get, update, and manage\n  permissions on Unity Catalog securable objects. It provides programmatic control over access to catalogs,\n  schemas, tables, volumes, and other data assets, enabling fine-grained data governance.\n"
