...
source_yaml: "aid: autodesk:acc-model-properties-api\nname: Autodesk ACC Model Properties API\ndescription: The ACC Model Properties API queries and compares model data across versions for element\n  tracking and analysis within Autodesk Construction Cloud.\nhumanURL: https://aps.autodesk.com/developer/overview/autodesk-construction-cloud\nbaseURL: https://developer.api.autodesk.com\ntags:\n- BIM\n- Construction\n- Model Properties\nproperties:\n- type: Documentation\n  url: https://aps.autodesk.com/developer/overview/autodesk-construction-cloud\n"
