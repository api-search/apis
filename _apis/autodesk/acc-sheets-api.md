...
slug: acc-sheets-api
source_yaml: "aid: autodesk:acc-sheets-api\nname: Autodesk ACC Sheets API\ndescription: The ACC Sheets API handles construction sheet set management, versioning, and distribution\n  across project teams within Autodesk Construction Cloud.\nhumanURL: https://aps.autodesk.com/developer/overview/autodesk-construction-cloud\nbaseURL: https://developer.api.autodesk.com\ntags:\n- Construction\n- Document Management\n- Sheets\nproperties:\n- type: Documentation\n  url: https://aps.autodesk.com/developer/overview/autodesk-construction-cloud\n"
