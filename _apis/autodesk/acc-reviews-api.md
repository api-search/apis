...
source_yaml: "aid: autodesk:acc-reviews-api\nname: Autodesk ACC Reviews API\ndescription: The ACC Reviews API manages approval workflows and file reviews, enabling tracking of review\n  status, automation of approval processes, and integration with document control systems.\nhumanURL: https://aps.autodesk.com/developer/overview/autodesk-construction-cloud\nbaseURL: https://developer.api.autodesk.com\ntags:\n- Approvals\n- Construction\n- Reviews\nproperties:\n- type: Documentation\n  url: https://aps.autodesk.com/developer/overview/autodesk-construction-cloud\n"
