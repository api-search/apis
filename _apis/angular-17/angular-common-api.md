...
source_yaml: "aid: angular-17:angular-common-api\nname: Angular 17 Common API\ntags:\n- Directives\n- Pipes\n- Utilities\nimage: https://kinlane-productions2.s3.amazonaws.com/apis-json/apis-json-logo.jpg\nbaseURL: https://angular.dev/api/common\nhumanURL: https://v17.angular.io/api/common\nproperties:\n- url: https://v17.angular.io/api/common\n  type: Documentation\ndescription: Common Angular 17 directives and pipes. Many NgIf/NgFor use cases are replaced by the new\n  built-in control flow syntax in Angular 17.\n"
