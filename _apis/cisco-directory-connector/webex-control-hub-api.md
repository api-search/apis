...
source_yaml: "aid: cisco-directory-connector:webex-control-hub-api\nname: Webex Control Hub API\ntags:\n- Administration\n- Licenses\n- Organizations\n- Users\nhumanURL: https://admin.webex.com\nbaseURL: https://webexapis.com/v1\nproperties:\n- url: https://developer.webex.com/docs/api/v1/organizations\n  type: Documentation\n- url: https://developer.webex.com/docs/api/v1/openapi.json\n  type: OpenAPI\n- url: https://admin.webex.com\n  type: Console\ndescription: Administrative API for managing Webex organizations, including users, groups, licenses, and\n  directory-sync settings.\n"
