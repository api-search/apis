...
source_yaml: "aid: camara:device-identifier-api\nname: CAMARA Device Identifier API\ndescription: Returns a privacy-preserving identifier for a device associated with a network-attached session,\n  enabling correlation and authentication flows while minimising exposure of raw MSISDNs or IMEIs.\nhumanURL: https://github.com/camaraproject/DeviceIdentifier\nbaseURL: https://api.example.com/device-identifier/v0\ntags:\n- Identity\n- Privacy\nproperties:\n- type: Documentation\n  url: https://github.com/camaraproject/DeviceIdentifier\n- type: Repository\n  url: https://github.com/camaraproject/DeviceIdentifier\n"
