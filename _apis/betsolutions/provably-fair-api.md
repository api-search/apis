...
source_yaml: "aid: betsolutions:provably-fair-api\nname: BetSolutions Provably Fair Games API\ntags:\n- Provably Fair\n- Zeppelin\n- Gaming\nhumanURL: https://docs.betsolutions.com/\nproperties:\n- type: Documentation\n  url: https://docs.betsolutions.com/\ndescription: Provably fair game integration for Zeppelin, High Low, Dice, Mines, and Plinko. Provides\n  jackpot history, multiplier history, and freebet creation for provably fair game mechanics.\n"
