...
source_yaml: "aid: betsolutions:third-party-api\nname: BetSolutions Third-Party Integration API\ntags:\n- Sportsbook\n- BCBetting\n- Integration\nhumanURL: https://docs.betsolutions.com/\nproperties:\n- type: Documentation\n  url: https://docs.betsolutions.com/\ndescription: Third-party sportsbook integration starting with BCBetting, providing bet retrieval, bonus\n  management, and player-specific bonus operations.\n"
