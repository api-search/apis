...
source_yaml: "aid: acronis:disaster-recovery-service-api\nname: Acronis Disaster Recovery Service API\ntags:\n- Acronis\n- Disaster Recovery\nhumanURL: https://developer.acronis.com/doc/disaster-recovery/v2/reference/index.html\nproperties:\n- type: Documentation\n  url: https://developer.acronis.com/doc/outbound/apis/api-library/dr/index.html\ndescription: The Acronis Disaster Recovery Service API allows organizations to automate and streamline\n  their disaster recovery processes.\n"
