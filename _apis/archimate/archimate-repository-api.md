...
source_yaml: "aid: archimate:archimate-repository-api\nname: ArchiMate Repository API\ndescription: RESTful API for accessing and managing ArchiMate models, elements, relationships, and views\n  stored in a central enterprise architecture repository.\nhumanURL: https://www.opengroup.org/archimate-forum\ntags:\n- Repository Management\n- Model Management\n- REST API\n- Enterprise Architecture\nproperties:\n- type: Documentation\n  url: https://pubs.opengroup.org/architecture/archimate3-doc/\n- type: OpenAPI\n  url: https://raw.githubusercontent.com/api-evangelist/archimate/refs/heads/main/openapi/archimate-repository-api.yaml\n"
