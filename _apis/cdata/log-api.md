...
source_yaml: "aid: cdata:log-api\nname: CData Log API\ntags:\n- Audit\n- Logs\n- Observability\nhumanURL: https://cloud.cdata.com/docs/Log-API.html\nproperties:\n- url: https://cloud.cdata.com/docs/Log-API.html\n  type: Documentation\ndescription: The CData Cloud Log API retrieves operational logs for queries, jobs, and connection events,\n  enabling observability of the CData Connect Cloud service.\n"
