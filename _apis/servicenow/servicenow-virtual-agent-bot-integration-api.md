...
source_yaml: "aid: servicenow:servicenow-virtual-agent-bot-integration-api\nname: ServiceNow Virtual Agent Bot Integration API\ntags:\n- Chatbot\n- Conversational AI\n- Self-Service\n- Virtual Agent\nimage: https://www.servicenow.com/content/dam/servicenow-assets/images/meganav/servicenow-logo.svg\nhumanURL: https://www.servicenow.com/docs/bundle/yokohama-api-reference/page/integrate/inbound-rest/concept/bot-api.html\nbaseURL: https://{instance}.service-now.com/api/sn_va_as_service\nproperties:\n- url: https://www.servicenow.com/docs/bundle/yokohama-api-reference/page/integrate/inbound-rest/concept/bot-api.html\n  type: Documentation\ndescription: The ServiceNow Virtual Agent Bot Integration API provides REST endpoints for integrating\n  external messaging platforms and chatbot frameworks with ServiceNow Virtual Agent. It enables sending\n  and receiving conversational messages to automate employee and customer self-service through AI-powered\n  virtual agents.\n"
