...
source_yaml: "aid: bloomberg-excel-plug-ins:bloomberg-bql-excel\nname: Bloomberg BQL in Excel\ndescription: Access Bloomberg Query Language (BQL) directly within Excel to run flexible, custom queries\n  for financial data, analytics, and derived metrics using the Bloomberg BQL Add-in.\nhumanURL: https://www.bloomberg.com/professional/solution/bloomberg-excel/\nbaseURL: https://bloomberg.com/bql-excel\ntags:\n- BQL\n- Excel\n- Query Language\n- Analytics\nproperties:\n- type: Documentation\n  url: https://www.bloomberg.com/professional/solution/bloomberg-excel/\n"
