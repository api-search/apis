...
source_yaml: "aid: avaloq:avaloq-trading-api\nname: Avaloq Trading API\ndescription: Order management and trading API for executing equity, fixed income, and multi-asset trades\n  through the Avaloq banking platform. Supports order lifecycle management, execution, and settlement.\nhumanURL: https://developer.avaloq.com/\nbaseURL: https://api.avaloq.com\ntags:\n- Banking\n- Financial Services\n- Order Management\n- Trading\nproperties:\n- type: Documentation\n  url: https://developer.avaloq.com/\n- type: OpenAPI\n  url: https://raw.githubusercontent.com/api-evangelist/avaloq/refs/heads/main/openapi/avaloq-trading-openapi.yml\n"
