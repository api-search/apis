...
source_yaml: "aid: avaloq:avaloq-payments-api\nname: Avaloq Payments API\ndescription: Payments processing API supporting domestic and international payment instructions, SEPA\n  transfers, SWIFT messaging, and real-time payment rails for banking clients.\nhumanURL: https://developer.avaloq.com/\nbaseURL: https://api.avaloq.com\ntags:\n- Banking\n- Payments\n- SEPA\n- SWIFT\nproperties:\n- type: Documentation\n  url: https://developer.avaloq.com/\n- type: OpenAPI\n  url: https://raw.githubusercontent.com/api-evangelist/avaloq/refs/heads/main/openapi/avaloq-payments-openapi.yml\n"
