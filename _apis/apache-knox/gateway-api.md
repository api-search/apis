...
source_yaml: "aid: apache-knox:gateway-api\nname: Apache Knox Gateway API\ndescription: The Knox gateway proxies and secures access to Hadoop ecosystem services including HDFS WebHDFS,\n  Hive, HBase REST, YARN, Oozie, Ambari, and Ranger with authentication and authorization enforcement.\nhumanURL: https://knox.apache.org/books/knox-2-0-0/user-guide.html#Service+Details\ntags:\n- API Gateway\n- Hadoop\n- Proxy\n- Security\nproperties:\n- type: Documentation\n  url: https://knox.apache.org/books/knox-2-0-0/user-guide.html#Service+Details\n"
