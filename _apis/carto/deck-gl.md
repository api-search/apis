...
provider_slug: carto
slug: deck-gl
source_yaml: "aid: carto:deck-gl\nname: CARTO for deck.gl\ndescription: Client library providing deck.gl layers for CARTO vector, H3, quadbin, raster, and query\n  sources, simplifying application-layer integration with the Maps API.\nhumanURL: https://docs.carto.com/carto-for-developers/carto-for-deck.gl\ntags:\n- SDK\n- deck.gl\n- Client Library\nproperties:\n- type: Documentation\n  url: https://docs.carto.com/carto-for-developers/carto-for-deck.gl\n- type: Repository\n  url: https://github.com/CartoDB/deck.gl\n"
