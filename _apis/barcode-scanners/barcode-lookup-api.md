...
source_yaml: "aid: barcode-scanners:barcode-lookup-api\nname: Barcode Lookup API\ndescription: Retrieve product information by scanning or entering barcode numbers including UPC, EAN,\n  and ISBN codes. Returns product name, description, category, images, and retail price data.\nhumanURL: https://www.barcodelookup.com/api\nbaseURL: https://api.barcodelookup.com/v3\ntags:\n- Barcodes\n- EAN\n- Product Lookup\n- UPC\nproperties:\n- type: Documentation\n  url: https://www.barcodelookup.com/api\n"
