...
source_yaml: "aid: alphabet:google-workspace-api\nname: Google Workspace API\ndescription: Google Workspace APIs provide programmatic access to Gmail, Drive, Calendar, Docs, Sheets,\n  Slides, and other productivity applications for workflow automation and enterprise application integration.\nhumanURL: https://developers.google.com/workspace\nbaseURL: https://www.googleapis.com\ntags:\n- Productivity\n- Email\n- Documents\n- Calendar\nproperties:\n- url: https://developers.google.com/workspace\n  type: Documentation\n"
