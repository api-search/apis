...
source_yaml: "aid: azure-cloud:azure-databases-api\nname: Azure Databases API\ndescription: Managed database REST APIs for Azure SQL Database, Azure Cosmos DB, Azure Database for PostgreSQL,\n  Azure Database for MySQL, and Azure Cache for Redis.\nhumanURL: https://learn.microsoft.com/en-us/rest/api/sql/\nbaseURL: https://management.azure.com\ntags:\n- Cosmos DB\n- Databases\n- MySQL\n- NoSQL\n- PostgreSQL\n- Redis\n- SQL\nproperties:\n- type: Documentation\n  url: https://learn.microsoft.com/en-us/rest/api/sql/\n"
