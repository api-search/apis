...
source_yaml: "aid: cloudability:anomalies\nname: Cloudability Anomaly Detection API\ntags:\n- Alerts\n- Anomaly Detection\n- Cost Optimization\nimage: https://kinlane-productions2.s3.amazonaws.com/apis-json/apis-json-logo.jpg\nbaseURL: https://api.cloudability.com/v3/anomalies\nhumanURL: https://www.ibm.com/docs/en/cloudability-commercial/cloudability-premium/saas\nproperties:\n- url: https://www.ibm.com/docs/en/cloudability-commercial/cloudability-premium/saas\n  type: Documentation\ndescription: The Anomalies API exposes detected cost anomalies on dimensions such as service, account,\n  and business mapping. Callers can query open anomalies, retrieve baseline / actual cost deltas, classify\n  anomalies, and acknowledge them through the API.\n"
