...
source_yaml: "aid: bloomberg-sustainable-finance-products:sfdr-api\nname: Bloomberg SFDR Data API\ndescription: Access Principal Adverse Indicators (PAIs) and other data points required for EU Sustainable\n  Finance Disclosure Regulation (SFDR) reporting for investment products and portfolios.\nhumanURL: https://www.bloomberg.com/professional/solution/regulatory-data/\nbaseURL: blpapi://localhost:8194\ntags:\n- SFDR\n- PAI\n- Regulatory\n- EU Taxonomy\n- Disclosure\nproperties:\n- type: Documentation\n  url: https://www.bloomberg.com/professional/solution/regulatory-data/\n"
